...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0035; //0.0030096922; //0.0047; //0.005;
        public double lateralInPerTick = 0.0028; //0.002532992185974359;
        public double trackWidthTicks = 5267.9896878328145;

        // feedforward parameters (in tick units)
        public double kS = 0.5537657919385788;
        public double kV = 0.0006119745355373862;
        public double kA = 0;

        // path profile parameters (in inches)
        public double maxWheelVel = 25; //50; REDUCED FOR TILE TESTING
        public double minProfileAccel = -15; //-30; REDUCED FOR TILE TESTING
        public double maxProfileAccel = 25; // 50; REDUCED FOR TILE TESTING
