...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1754.3672811998279; //1760.1633279412165; //0.0; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2508.8816351318656; //2422.0010905838217; // 0.0; // x position of the perpendicular encoder (in tick units)
    }
