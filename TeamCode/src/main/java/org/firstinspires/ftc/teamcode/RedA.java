...
//            );
        ...
        if (propDirectionID == PropDirection.LEFT || propDirectionID == PropDirection.RIGHT){
            Actions.runBlocking(
                    drive.actionBuilder(drive.pose)
                            ...
                            .strafeToConstantHeading(new Vector2d(startXPos - 24, startYPos + 24))
            ...
            if (propDirectionID == PropDirection.LEFT){
                Actions.runBlocking(
                        drive.actionBuilder(drive.pose)
                                .strafeToConstantHeading(new Vector2d(startXPos, startYPos + 34))
                                .build()
                );
            ...
            if (propDirectionID == PropDirection.RIGHT){
                Actions.runBlocking(
                        drive.actionBuilder(drive.pose)
                                .strafeToConstantHeading(new Vector2d(startXPos, startYPos + 12))
                                .build()
                );
    ...
    private void setupForPxlTwo(){
        Actions.runBlocking(
                drive.actionBuilder(drive.pose)
                        .strafeToConstantHeading(new Vector2d(34.07, -58.60))
                        .strafeToConstantHeading(new Vector2d(9.64, -56.23))
                        .strafeToConstantHeading(new Vector2d(11.49, 33.86))
...
//                        .splineToConstantHeading(new Vector2d(36.23, 51.49), Math.toRadians(90.00))
    ...
    // WONT WORK! TODO FIX Heading switch
...
//        );
        if (propDirectionID == RedA.PropDirection.LEFT || propDirectionID == RedA.PropDirection.RIGHT){
            Actions.runBlocking(
                    drive.actionBuilder(drive.pose)
                            .strafeToConstantHeading(new Vector2d(startXPos + 80, startYPos))
                            .build()
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.pose)
                            ...
                            .strafeToConstantHeading(new Vector2d(startXPos + 108, startYPos))
                            .build()
    ...
    private void park(){
        ...
        Actions.runBlocking(
                drive.actionBuilder(drive.pose)
                        .strafeToConstantHeading(new Vector2d(startXPos - 45, startYPos - 220))
                        .build()
