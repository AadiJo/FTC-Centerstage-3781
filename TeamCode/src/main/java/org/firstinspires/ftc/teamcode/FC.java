        ...
        while (!isStopRequested()) {
...

            {
                ...
                if (gamepad2.left_trigger > 0.5 && gamepad2.right_trigger > 0.5){
                    ...
                    droneMotor.setVelocity(-0.9 * VARS.maxTicksPerSec);
