...
public class BlueB extends LinearOpMode {
    ...
    BlueB.PropDirection propDirectionID;
        ...
        if (propDirectionID == PropDirection.LEFT || propDirectionID == PropDirection.RIGHT){
            Actions.runBlocking(
                    drive.actionBuilder(drive.pose)
                            ...
                            .strafeToConstantHeading(new Vector2d(startXPos + 43, startYPos + 70))
                            .build()
            );
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.pose)
                            ...
                            .strafeToConstantHeading(new Vector2d(startXPos + 24, startYPos + 45))
                            .build()
            );
            turn(-90);
        }
