...
@Autonomous(name = "Red B Testing")
// TODO CLAMP VALUES AS NEEDED
public class RedB_Testing extends LinearOpMode {
...
//                        .splineToConstantHeading(new Vector2d(-36.23, 51.49), Math.toRadians(90.00))
    ...
    private void park(){
        ...
        Actions.runBlocking(
                drive.actionBuilder(drive.pose)
                        .strafeToLinearHeading(new Vector2d(drive.pose.position.x, drive.pose.position.y + 12), Math.toRadians(180))
                        .build()
        );
