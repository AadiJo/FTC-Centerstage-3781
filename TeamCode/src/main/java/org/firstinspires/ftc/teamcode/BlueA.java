...
//        );
        if (propDirectionID == BlueA.PropDirection.LEFT || propDirectionID == BlueA.PropDirection.RIGHT){
            Actions.runBlocking(
                    drive.actionBuilder(drive.pose)
                            .strafeToConstantHeading(new Vector2d(startXPos + 52, startYPos))
                            .build()
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.pose)
                            .strafeToConstantHeading(new Vector2d(startXPos + 25, startYPos))
                            .strafeToConstantHeading(new Vector2d(startXPos + 20, startYPos - 20))
                            .strafeToConstantHeading(new Vector2d(startXPos + 70, startYPos - 20))
                            .strafeToConstantHeading(new Vector2d(startXPos + 70, startYPos))
                            .build()
    ...
    private void goToBackdrop(){
        Actions.runBlocking(
                drive.actionBuilder(drive.pose)
                        .splineToConstantHeading(new Vector2d(-51.12, 38.63), Math.toRadians(0))
