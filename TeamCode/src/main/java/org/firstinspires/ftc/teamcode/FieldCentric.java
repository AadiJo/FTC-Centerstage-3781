...
@TeleOp(name = "Field Centric", group = "Pirhos")
public class FieldCentric extends LinearOpMode {
    ...
    private DcMotor droneMotor;

    private double droneRPM = 1620; // out of 1620
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double initClawRPos = clawR.getPosition();
