...
@TeleOp(name = "TeleOP using April Tags V2", group = "Current")
public class FC_AprilTag_V2 extends LinearOpMode {
...
//            leftFront.setInverted(true);
        ...
        while (!isStopRequested()) {
            ...
            if(gamepad1.left_bumper) {
                ...
                ElapsedTime aprilTagTime = new ElapsedTime(ElapsedTime.Resolution.SECONDS);
                aprilTagTime.reset();
                while (aprilTagTime.seconds() < 2.5){
